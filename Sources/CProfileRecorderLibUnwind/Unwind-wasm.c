...
_swipr_Unwind_Reason_Code __gxx_personality_wasm0(int version, _swipr_Unwind_Action actions,
                                            uint64_t exceptionClass,
                                            _swipr_Unwind_Exception *unwind_exception,
                                            _swipr_Unwind_Context *context);

struct _swipr_Unwind_LandingPadContext {
...
// function
thread_local struct _swipr_Unwind_LandingPadContext __wasm_lpad_context;
...
_swipr_Unwind_Reason_Code _swipr_Unwind_CallPersonality(void *exception_ptr) {
  struct _swipr_Unwind_Exception *exception_object =
      (struct _swipr_Unwind_Exception *)exception_ptr;
  _LIBUNWIND_TRACE_API("_swipr_Unwind_CallPersonality(exception_object=%p)",
  ...
  return __gxx_personality_wasm0(
      ...
      (struct _swipr_Unwind_Context *)&__wasm_lpad_context);
}
...
_swipr_Unwind_RaiseException(_swipr_Unwind_Exception *exception_object) {
  _LIBUNWIND_TRACE_API("_swipr_Unwind_RaiseException(exception_object=%p)",
                       (void *)exception_object);
...
_LIBUNWIND_EXPORT void _swipr_Unwind_SetGR(struct _swipr_Unwind_Context *context, int index,
                                     uintptr_t value) {
  _LIBUNWIND_TRACE_API("_swipr_Unwind_SetGR(context=%p, index=%d, value=%lu)",
  ...
  if (index == 1)
    ((struct _swipr_Unwind_LandingPadContext *)context)->selector = value;
}
...
_LIBUNWIND_EXPORT uintptr_t _swipr_Unwind_GetIP(struct _swipr_Unwind_Context *context) {
  ...
  // increment 2 here
  uintptr_t result =
      ((struct _swipr_Unwind_LandingPadContext *)context)->lpad_index + 2;
  _LIBUNWIND_TRACE_API("_swipr_Unwind_GetIP(context=%p) => %lu", (void *)context,
                       result);
  return result;
}
...
_swipr_Unwind_GetLanguageSpecificData(struct _swipr_Unwind_Context *context) {
  uintptr_t result = ((struct _swipr_Unwind_LandingPadContext *)context)->lsda;
  _LIBUNWIND_TRACE_API("_swipr_Unwind_GetLanguageSpecificData(context=%p) => 0x%lx",
                       (void *)context, result);
  return result;
}
