...
#if defined(_AIX)
extern uintptr_t __swipr_unw_get_data_rel_base(swipr_unw_cursor_t *);
#endif
...
extern void __swipr_unw_add_dynamic_eh_frame_section(swipr_unw_word_t eh_frame_start);
extern void __swipr_unw_remove_dynamic_eh_frame_section(swipr_unw_word_t eh_frame_start);
...
//
// See the swipr_unw_find_dynamic_unwind_sections type below for more details.
struct swipr_unw_dynamic_unwind_sections {
  swipr_unw_word_t dso_base;
  swipr_unw_word_t dwarf_section;
  size_t     dwarf_section_length;
  swipr_unw_word_t compact_unwind_section;
  size_t     compact_unwind_section_length;
};

// Typedef for unwind-info lookup callbacks. Functions of this type can be
// registered and deregistered using __swipr_unw_add_find_dynamic_unwind_sections
// and __swipr_unw_remove_find_dynamic_unwind_sections respectively.
//
...
typedef int (*swipr_unw_find_dynamic_unwind_sections)(
    swipr_unw_word_t addr, struct swipr_unw_dynamic_unwind_sections *info);
...
// any eh-frames registered via __swipr_register_frame or
// __swipr_unw_add_dynamic_eh_frame_section.
//
...
extern int __swipr_unw_add_find_dynamic_unwind_sections(
...
extern int __swipr_unw_remove_find_dynamic_unwind_sections(
    swipr_unw_find_dynamic_unwind_sections find_dynamic_unwind_sections);
