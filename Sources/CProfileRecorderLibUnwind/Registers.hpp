...
inline Registers_x86::Registers_x86(const void *registers) {
  static_assert((check_fit<Registers_x86, swipr_unw_context_t>::does_fit),
                "x86 registers do not fit into swipr_unw_context_t");
...
inline Registers_x86_64::Registers_x86_64(const void *registers) {
  static_assert((check_fit<Registers_x86_64, swipr_unw_context_t>::does_fit),
                "x86_64 registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, registers, sizeof(_registers));
}
...
inline Registers_ppc::Registers_ppc(const void *registers) {
  static_assert((check_fit<Registers_ppc, swipr_unw_context_t>::does_fit),
                "ppc registers do not fit into swipr_unw_context_t");
...
inline Registers_ppc64::Registers_ppc64(const void *registers) {
  static_assert((check_fit<Registers_ppc64, swipr_unw_context_t>::does_fit),
                "ppc64 registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
...
inline Registers_arm64::Registers_arm64(const void *registers) {
  static_assert((check_fit<Registers_arm64, swipr_unw_context_t>::does_fit),
                "arm64 registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, registers, sizeof(_registers));
...
public:
  ...
  void        setRegister(int num, uint32_t value);
  bool        validFloatRegister(int num) const;
  swipr_unw_fpreg_t getFloatRegister(int num);
  void        setFloatRegister(int num, swipr_unw_fpreg_t value);
  bool        validVectorRegister(int num) const;
  v128        getVectorRegister(int num) const;
  void        setVectorRegister(int num, v128 value);
  static const char *getRegisterName(int num);
...
private:
  ...
  swipr_unw_fpreg_t _vfp_d0_d15_pad[17];
  // VFPv3 registers D16-D31, always saved using FSTMD
  swipr_unw_fpreg_t _vfp_d16_d31[16];
#if defined(__ARM_WMMX)
...
inline Registers_arm::Registers_arm(const void *registers)
  ...
  static_assert((check_fit<Registers_arm, swipr_unw_context_t>::does_fit),
                "arm registers do not fit into swipr_unw_context_t");
  // See __swipr_unw_getcontext() note about data.
  memcpy(&_registers, registers, sizeof(_registers));
...
inline bool Registers_arm::validFloatRegister(int regNum) const {
  ...
  // __swipr_unw_get_fpreg can be used to transmit the 64-bit data back.
...
inline swipr_unw_fpreg_t Registers_arm::getFloatRegister(int regNum) {
...
inline void Registers_arm::setFloatRegister(int regNum, swipr_unw_fpreg_t value) {
  if (regNum >= UNW_ARM_D0 && regNum <= UNW_ARM_D15) {
    if (!_saved_vfp_d0_d15) {
      _saved_vfp_d0_d15 = true;
      if (_use_X_for_vfp_save)
...
inline Registers_or1k::Registers_or1k(const void *registers) {
  static_assert((check_fit<Registers_or1k, swipr_unw_context_t>::does_fit),
                "or1k registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_mips_o32::Registers_mips_o32(const void *registers) {
  static_assert((check_fit<Registers_mips_o32, swipr_unw_context_t>::does_fit),
                "mips_o32 registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_mips_newabi::Registers_mips_newabi(const void *registers) {
  static_assert((check_fit<Registers_mips_newabi, swipr_unw_context_t>::does_fit),
                "mips_newabi registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_sparc::Registers_sparc(const void *registers) {
  static_assert((check_fit<Registers_sparc, swipr_unw_context_t>::does_fit),
                "sparc registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_sparc64::Registers_sparc64(const void *registers) {
  static_assert((check_fit<Registers_sparc64, swipr_unw_context_t>::does_fit),
                "sparc64 registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, registers, sizeof(_registers));
  memcpy(&_wcookie,
         static_cast<const uint8_t *>(registers) + sizeof(_registers),
         sizeof(_wcookie));
...
inline Registers_hexagon::Registers_hexagon(const void *registers) {
  static_assert((check_fit<Registers_hexagon, swipr_unw_context_t>::does_fit),
                "hexagon registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_riscv::Registers_riscv(const void *registers) {
  static_assert((check_fit<Registers_riscv, swipr_unw_context_t>::does_fit),
                "riscv registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, registers, sizeof(_registers));
# if __riscv_xlen == 32
...
inline Registers_ve::Registers_ve(const void *registers) {
  static_assert((check_fit<Registers_ve, swipr_unw_context_t>::does_fit),
                "ve registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
...
inline Registers_s390x::Registers_s390x(const void *registers) {
  static_assert((check_fit<Registers_s390x, swipr_unw_context_t>::does_fit),
                "s390x registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, static_cast<const uint8_t *>(registers),
         sizeof(_registers));
}
...
inline Registers_loongarch::Registers_loongarch(const void *registers) {
  static_assert((check_fit<Registers_loongarch, swipr_unw_context_t>::does_fit),
                "loongarch registers do not fit into swipr_unw_context_t");
  memcpy(&_registers, registers, sizeof(_registers));
